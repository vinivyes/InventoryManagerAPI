...
namespace InventoryManagerAPI.Migrations
{
    ...
    [Migration("20230411005103_AddUser")]
            ...
            modelBuilder.Entity("InventoryManagerAPI.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            first_name = "Admin",
                            last_name = "",
                            password = "$2a$11$X8whmGCPeE3xY215mIaMDeo8suaQacms23dfMkgNaukosQpGPh3u.",
                            passwordDate = new DateTime(2023, 4, 11, 0, 51, 3, 191, DateTimeKind.Utc).AddTicks(4859)
                        });
                });
